...
public class PerformanceYwlWdywl{
    ...
    private BigDecimal zxjll;
    private BigDecimal zywbs;
	...
	public BigDecimal getZxjll() {
		return zxjll;
	}
	public BigDecimal getZywbs() {
		return zywbs;
	}
	...
	public void setZxjll(BigDecimal zxjll) {
		this.zxjll = zxjll;
	}
	public void setZywbs(BigDecimal zywbs) {
		this.zywbs = zywbs;
	}
