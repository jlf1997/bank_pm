...
<html>
  ...
  <body >
  <div>
	<form action="${pageContext.request.contextPath}/findPerformanceCkAljcgzMx.action?yggh=${yggh}&type=${type}" method="post" 
...
<script type="text/javascript">
	var url = '${pageContext.request.contextPath}/findPerformanceCkAljcgzMx.action?yggh=${yggh}&type=${type}';
  	function jumpPage(){
