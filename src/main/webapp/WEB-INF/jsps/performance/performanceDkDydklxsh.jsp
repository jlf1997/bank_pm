...
<html>
  ...
  <body >
  <div>
	<form action="${pageContext.request.contextPath}/findPerformanceDkDydklxshMx.action?yggh=${yggh}" method="post" 
	  class="form-inline" role="form" style="margin-top:1%;margin-left:1%;" id="form">
		  ...
		  <div class="form-group">
		  	<input type="text" class="form-control" placeholder="客户名称|贷款账户" name="condition" value="${condition}"/>
		  </div>
  ...
  <script type="text/javascript">
	var url = '${pageContext.request.contextPath}/findPerformanceDkDydklxshMx.action?yggh=${yggh}';
  	function jumpPage(){
