...
<html>
  ...
  <body >
  <div>
	  <form action="${pageContext.request.contextPath}/findPerformanceCellBankTradeMx.action?yggh=${yggh}" method="post" 
		  ...
		  <button type="submit" class="btn btn-primary">查询</button>
		   ...
		   <c:forEach items="${list}" var="item">
		   	<tr>
		   		...
		   		<td>${item.mobile}</td>   		
		   		<td>${item.subtime}</td>
		   		<td align="right">${item.tranamt}</td>
...
<script type="text/javascript">
	var url = '${pageContext.request.contextPath}/findPerformanceCellBankTradeMx.action?yggh=${yggh}';
  	function jumpPage(){
