...
<html>
  ...
  <body >
  <div>
	  <form action="${pageContext.request.contextPath}/findPerformanceEtcHsgzMx.action?yggh=${yggh}&ghlx=${ghlx}" method="post" 
	  class="form-inline" role="form" style="margin-top:1%;margin-left:1%;" id="form">
		  ...
		  <div class="form-group">
		  	<input type="text" class="form-control" placeholder="客户名称|湘通卡卡号" name="condition" value="${condition}"/>
		  </div>
  ...
  <script type="text/javascript">
	var url = '${pageContext.request.contextPath}/findPerformanceEtcHsgzMx.action?yggh=${yggh}&ghlx=${ghlx}';
  	function jumpPage(){
