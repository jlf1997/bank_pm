...
<body>
	<div>
		<form
			action="${pageContext.request.contextPath}/findPerformanceCbBmkkhhsMx.action?yggh=${yggh}"
			method="post" class="form-inline" role="form" id="form" style="margin-top:1%;margin-left:1%;">
			<div class="form-group">
				<label class="label label-default">工资合计:</label> ${hj} 元 <label
					class="label label-default">工资日期:</label> <input type="text"
					class="form-control" readonly value="${tjrq}" name="tjrq" />
			</div>
			<div class="form-group">
				<input type="text" class="form-control" placeholder="客户名称|证件号码"
...
<script type="text/javascript">
	var url = '${pageContext.request.contextPath}/findPerformanceCbBmkkhhsMx.action?yggh=${yggh}';
  	function jumpPage(){
